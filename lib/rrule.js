...
var RRule = function(options, noCache) {
    ...
    var defaults = xtend({}, RRule.DEFAULT_OPTIONS);
    options = options || {};
    ...
    var invalid = Object.keys(options).filter(function(name){
    ...
    // used by toString()
    this.origOptions = xtend({}, options);
    var opts;
    this.options = opts = xtend({}, defaults, options);
...
RRule.optionsToString = function(options) {
    ...
    keys = intersect(Object.keys(RRule.DEFAULT_OPTIONS), Object.keys(options));
